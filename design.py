...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget.setGeometry(QRect(20, 130, 201, 401))
        ...
        self.BDBox.setGeometry(QRect(270, 40, 221, 22))
        self.addXlsBtn = QPushButton(self.BDtab)
        self.addXlsBtn.setObjectName(u"addXlsBtn")
        self.addXlsBtn.setGeometry(QRect(380, 80, 111, 31))
        ...
        self.baseInfo.setGeometry(QRect(270, 130, 491, 401))
        ...
        self.groupBox.setGeometry(QRect(510, 30, 181, 91))
        ...
        self.groupBox_2.setGeometry(QRect(690, 30, 61, 91))
